...
const ConnectLinks: React.FC<ConnectLinksProps> = ({
  heading = 'Connect With Me',
  description = "I'm always interested in discussing data science, machine learning, and innovative technology solutions.",
  variant = 'subtle',
}) => {
  ...
  return (
  <section
    className={`${styles.connectSection} ${styles[variant]}`}
  ...
  >
    <div className="section-container">
      ...
      <p className={styles.connectDescription}>{description}</p>
      <div className={styles.connectLinks}>
        ...
        <button
          ...
          >
            <Icon path="M20 4H4c-1.1 0-2 .9-2 2v12c0 1.1.9 2 2 2h16c1.1 0 2-.9 2-2V6c0-1.1-.9-2-2-2zm0 4-8 5-8-5V6l8 5 8-5v2z" />
            <span>Email</span>
          </button>
      </div>
